...
public class ResourceEdge : Edge
{
    ...
    /// <summary>
    /// How much resource is moving trough edge
    /// </summary>
...
public static class RecipePipelineBuilder
{
    ...
    //                     productionLines.InEdges(source.Id).Sum(se=>se.Get<double>("flow"));
    ...
    static void PlanarRender(IGraph<RecipeNode, ResourceEdge> resultGraph){
        ...
        var pos = resultGraph.Do.Arrange(200).Positions;
